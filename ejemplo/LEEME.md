...
4. **`06-banco-de-historias.md`, la tabla del final.** Dos preguntas comunes sin historia, dejadas a la vista en vez de inventar algo.
5. **`entrevistas/tiendas-lumbrera/simulacro.md`.** Tres tomas de "cuéntame de ti": de 94 segundos con "como 200 locales" a 63 segundos con los números de la evidencia. En la del medio se le escapó un número retirado justo en la última oración.
6. **`numeros-retirados.txt`.** Cuatro cosas que Toffy venía diciendo y dejó de decir. La última salió en el simulacro.
