...
La persona escribe `/empezar` y el comando la lleva al paso que le toca. Cada paso es una skill, y cada skill escribe un archivo en `mi-cerebro/`:
...
Claude puede dejar las respuestas escritas, y si tiene un navegador conectado puede ayudar a llenar los campos. **Nunca aprieta Enviar, Submit, Postularme ni nada que mande una postulación, un correo o un mensaje.** Tampoco publica ni edita el perfil de LinkedIn.
